...
def send_payment_message(customer, delivery, amount, ussd=None):
    sms = SMS()
    ussd = generate_ussd_code(customer.name.split()[0], amount, ussd or delivery.payment_option) #"*737*1*5555#"
